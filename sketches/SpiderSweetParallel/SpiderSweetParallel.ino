...
/*
Floodlight floodlight1(FLOODLIGHT_PIN1, LIGHT_ON);
Floodlight floodlight2(FLOODLIGHT_PIN2, LIGHT_ON);
Floodlight floodlight3(FLOODLIGHT_PIN3, LIGHT_ON);
Floodlight floodlight4(FLOODLIGHT_PIN4, LIGHT_ON);
Floodlight floodlight5(FLOODLIGHT_PIN5, LIGHT_ON);
Floodlight floodlight6(FLOODLIGHT_PIN6, LIGHT_ON);
floodlights.push_back(floodlight1);
floodlights.push_back(floodlight2);
floodlights.push_back(floodlight3);
floodlights.push_back(floodlight4);
floodlights.push_back(floodlight5);
floodlights.push_back(floodlight6);
*/
